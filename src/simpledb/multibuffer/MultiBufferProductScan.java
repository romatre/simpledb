...
/** 
 * The Scan class for the muti-simpledb.buffer version of the
...
public class MultiBufferProductScan implements Scan {
    ...
    * @param ti the simpledb.metadata for the RHS table
    ...
    * That is, the LHS scan is positioned at its first simpledb.record,
    * and the RHS scan is positioned before the first simpledb.record of the first chunk.
   ...
   /**
    * Moves to the next simpledb.record in the current scan.
    * If there are no more records in the current chunk,
    * then move to the next LHS simpledb.record and the beginning of that chunk.
