...
/**
 * The Plan class for the muti-simpledb.buffer version of the
...
public class MultiBufferProductPlan implements Plan {
    ...
    * @param lhs the plan for the LHS simpledb.query
    * @param rhs the plan for the RHS simpledb.query
   ...
   /**
    * A scan for this simpledb.query is created and returned, as follows.
    * First, the method materializes its RHS simpledb.query.
    * It then determines the optimal chunk size,
    * based on the size of the materialized simpledb.file and the
    ...
    * required to execute the simpledb.query. The formula is:
    ...
    * when the simpledb.query scan is opened.
    ...
    * the estimate is the same as in the appropriate underlying simpledb.query.
