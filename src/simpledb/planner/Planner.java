...
public class Planner {
   ...
   /**
    * Creates a plan for an SQL select statement, using the supplied simpledb.planner.
    * @param qry the SQL simpledb.query string
    * @param tx the transaction
    * @return the scan corresponding to the simpledb.query plan
    */
    ...
    * supplied update simpledb.planner,
