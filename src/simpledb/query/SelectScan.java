...
public class SelectScan implements UpdateScan {
    ...
    * scan and predicate.
    * @param s the scan of the underlying simpledb.query
   ...
   /**
    * Move to the next simpledb.record satisfying the predicate.
    * The method repeatedly calls next on the underlying scan
    * until a suitable simpledb.record is found, or the underlying scan
