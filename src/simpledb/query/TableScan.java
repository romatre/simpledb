...
public class TableScan implements UpdateScan {
    ...
    * and opens its corresponding simpledb.record simpledb.file.
    ...
    * If INTEGER, then the simpledb.record simpledb.file's getInt method is called;
    ...
    * The schema is examined to determine the field's type.
    * If INTEGER, then the simpledb.record simpledb.file's setInt method is called;
