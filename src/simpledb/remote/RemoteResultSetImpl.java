...
/**
 * The RMI simpledb.server-side implementation of RemoteResultSet.
...
class RemoteResultSetImpl extends UnicastRemoteObject implements RemoteResultSet {
    ...
    * @param plan the simpledb.query plan
    * @param rconn TODO
   ...
   /**
    * Moves to the next simpledb.record in the result set,
    * by moving to the next simpledb.record in the saved scan.
   ...
   /**
    * Returns the result set's simpledb.metadata,
