...
/**
 * The RMI simpledb.server-side implementation of RemoteStatement.
...
class RemoteStatementImpl extends UnicastRemoteObject implements RemoteStatement {
   ...
   /**
    * Executes the specified SQL simpledb.query string.
    * The method calls the simpledb.query simpledb.planner to create a plan
    * for the simpledb.query. It then sends the plan to the
    ...
    * The method sends the command to the update simpledb.planner,
    * which executes it.
