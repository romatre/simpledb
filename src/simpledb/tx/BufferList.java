...
class BufferList {
   ...
   /**
    * Returns the simpledb.buffer pinned to the specified block.
   ...
   /**
    * Pins the block and keeps track of the simpledb.buffer internally.
    * @param blk a reference to the disk block
    */
   void pin(Block blk) {
   ...
   /**
    * Appends a new block to the specified simpledb.file
    * and pins it.
