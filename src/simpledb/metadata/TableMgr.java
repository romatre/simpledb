...
/**
 * The table manager.
 * There are methods to create a table, save the simpledb.metadata
 * in the catalog, and obtain the simpledb.metadata of a
...
public class TableMgr {
   ...
   /**
    * Retrieves the simpledb.metadata for the specified table
    * out of the catalog.
    * @param tblname the name of the table
    * @param tx the transaction
    * @return the table's stored simpledb.metadata
    */
