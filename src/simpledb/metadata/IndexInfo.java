...
/**
 * The information about an simpledb.index.
 * This information is used by the simpledb.query simpledb.planner in order to
 * estimate the costs of using the simpledb.index,
 * and to obtain the schema of the simpledb.index records.
...
public class IndexInfo {
   ...
   /**
    * Creates an IndexInfo object for the specified simpledb.index.
    * @param idxname the name of the simpledb.index
   ...
   /**
    * Opens the simpledb.index described by this object.
    ...
    * find all simpledb.index records having a particular search key.
    * The method uses the table's simpledb.metadata to estimate the
    * size of the simpledb.index simpledb.file and the number of simpledb.index records
    * per block.
    * It then passes this information to the traversalCost
    * method of the appropriate simpledb.index type,
    * which provides the estimate.
    * @return the number of block accesses required to traverse the simpledb.index
    */
    ...
    * simpledb.query; that is, it is the number of records in the table
   ...
   /**
    * Returns the schema of the simpledb.index records.
    * The schema consists of the dataRID (which is
    * represented as two integers, the block number and the
    * simpledb.record ID) and the dataval (which is the indexed field).
    * Schema information about the indexed field is obtained
    * via the table's simpledb.metadata.
    * @return the schema of the simpledb.index records
    */
