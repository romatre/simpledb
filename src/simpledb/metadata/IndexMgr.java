...
/**
 * The simpledb.index manager.
 * The simpledb.index manager has similar functionalty to the table manager.
...
public class IndexMgr {
   ...
   /**
    * Creates the simpledb.index manager.
   ...
   /**
    * Creates an simpledb.index of the specified type for the specified field.
    * A unique ID is assigned to this simpledb.index, and its information
   ...
   /**
    * Returns a map containing the simpledb.index info for all indexes
