...
public class SimpleDB {
   ...
   /**
    * Initializes only the simpledb.file manager.
    * @param dirname the name of the database directory
    */
   ...
   /**
    * Initializes the simpledb.file and simpledb.log managers.
    * @param dirname the name of the database directory
    */
   ...
   /**
    * Initializes the simpledb.file, simpledb.log, and simpledb.buffer managers.
    * @param dirname the name of the database directory
    */
   ...
   /**
    * Initializes simpledb.metadata manager.
   ...
   /**
    * Creates a simpledb.planner for SQL commands.
    * To change how the simpledb.planner works, modify this method.
    * @return the system's simpledb.planner for SQL commands
