 ...
 * which makes sense because an simpledb.index join is essentially
 * the product of each LHS simpledb.record with the matching RHS simpledb.index records.
...
public class IndexJoinScan implements Scan {
   ...
   /**
    * Creates an simpledb.index join scan for the specified LHS scan and
    * RHS simpledb.index.
    * @param s the LHS scan
    * @param idx the RHS simpledb.index
    ...
    * first simpledb.record, and the simpledb.index will be positioned
    * before the first simpledb.record for the join value.
    ...
    * The method moves to the next simpledb.index simpledb.record, if possible.
    * Otherwise, it moves to the next LHS simpledb.record and the
    * first simpledb.index simpledb.record.
   ...
   /**
    * Closes the scan by closing its LHS scan and its RHS simpledb.index.
