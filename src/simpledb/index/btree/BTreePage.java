...
public class BTreePage {
    ...
    * @param ti the simpledb.metadata for the particular B-tree simpledb.file
   ...
   /**
    * Calculates the position where the first simpledb.record having
   ...
   /**
    * Closes the page by unpinning its simpledb.buffer.
    */
   public void close() {
      if (currentblk != null)
         tx.unpin(currentblk);
   ...
   /**
    * Returns the dataval of the simpledb.record at the specified slot.
    * @param slot the integer slot of an simpledb.index simpledb.record
    * @return the dataval of the simpledb.record at that slot
    */
   ...
   /**
    * Appends a new block to the end of the specified B-tree simpledb.file,
   ...
   /**
    * Returns the block number stored in the simpledb.index simpledb.record
    * at the specified slot.
    * @param slot the slot of an simpledb.index simpledb.record
    * @return the block number stored in that simpledb.record
    */
   ...
   /**
    * Returns the dataRID value stored in the specified leaf simpledb.index simpledb.record.
    * @param slot the slot of the desired simpledb.index simpledb.record
   ...
   /**
    * Inserts a leaf simpledb.index simpledb.record at the specified slot.
    * @param slot the slot of the desired simpledb.index simpledb.record
   ...
   /**
    * Deletes the simpledb.index simpledb.record at the specified slot.
    * @param slot the slot of the deleted simpledb.index simpledb.record
    */
   ...
   /**
    * Returns the number of simpledb.index records in this page.
    * @return the number of simpledb.index records in this page
    */
