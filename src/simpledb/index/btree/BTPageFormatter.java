...
public class BTPageFormatter implements PageFormatter {
    ...
    * specified B-tree simpledb.index.
    * @param ti the simpledb.index's simpledb.metadata
   ...
   /** 
    * Formats the page by initializing as many simpledb.index-simpledb.record slots
