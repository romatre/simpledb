...
public class BTreeIndex implements Index {
   ...
   /**
    * Opens a B-tree simpledb.index for the specified simpledb.index.
    ...
    * @param leafsch the schema of the leaf simpledb.index records
    ...
    * positions the page before the first simpledb.record (if any)
   ...
   /**
    * Moves to the next leaf simpledb.record having the
   ...
   /**
    * Returns the dataRID value from the current leaf simpledb.record.
   ...
   /**
    * Inserts the specified simpledb.record into the simpledb.index.
    * The method first traverses the directory to find
    * the appropriate leaf page; then it inserts
    * the simpledb.record into the leaf.
   ...
   /**
    * Deletes the specified simpledb.index simpledb.record.
    * The method first traverses the directory to find
    * the leaf page containing that simpledb.record; then it
    * deletes the simpledb.record from the page.
   ...
   /**
    * Closes the simpledb.index by closing its open leaf page,
    * if necessary.
    ...
    * required to find all simpledb.index records having
    * a particular search key.
    * @param numblocks the number of blocks in the B-tree directory
    * @param rpb the number of simpledb.index entries per block
