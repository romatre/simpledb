...
public class GroupByScan implements Scan {
    ...
    * positioned at the first simpledb.record of a group, which
    * means that this method moves to the
    * first underlying simpledb.record.
    ...
    * group values at the current simpledb.record.
    * The method repeatedly reads underlying records until
    * it encounters a simpledb.record having a different key.
    * The aggregation functions are called for each simpledb.record
    * in the group. 
    ...
    * @see simpledb.simpledb.query.Scan#hasField(java.lang.String)
    */
