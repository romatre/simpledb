...
/**
 * The Plan class for the <i>simpledb.materialize</i> operator.
...
public class MaterializePlan implements Plan {
   ...
   /**
    * Creates a simpledb.materialize plan for the specified simpledb.query.
    * @param srcplan the plan of the underlying simpledb.query
   ...
   /**
    * This method loops through the underlying simpledb.query,
   ...
   public int blocksAccessed() {
      // create a dummy TableInfo object to calculate simpledb.record length
