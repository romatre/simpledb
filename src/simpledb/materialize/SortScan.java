...
public class SortScan implements Scan {
    ...
    * @param comp the simpledb.record comparator
    */
   ...
   /**
    * Positions the scan before the first simpledb.record in sorted order.
    * Internally, it moves to the first simpledb.record of each underlying scan.
   ...
   /**
    * Moves to the next simpledb.record in sorted order.
    * First, the current scan is moved to the next simpledb.record.
    * Then the lowest simpledb.record of the two scans is found, and that
   ...
   /**
    * Saves the position of the current simpledb.record,
