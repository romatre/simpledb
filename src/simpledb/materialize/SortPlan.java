...
public class SortPlan implements Plan {
   ...
   /**
    * Creates a sort plan for the specified simpledb.query.
    * @param p the plan for the underlying simpledb.query
    ...
    * which is the same as in the underlying simpledb.query.
    ...
    * is the same as in the underlying simpledb.query.
