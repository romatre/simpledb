...
public class MergeJoinScan implements Scan {
   ...
   /**
    * Moves to the next simpledb.record.  This is where the action is.
    * <P>
    * If the next RHS simpledb.record has the same join value,
    * then move to it.
    * Otherwise, if the next LHS simpledb.record has the same join value,
    * then reposition the RHS scan back to the first simpledb.record
