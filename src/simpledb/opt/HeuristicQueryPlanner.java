...
/**
 * A simpledb.query simpledb.planner that optimizes using a heuristic-based algorithm.
...
public class HeuristicQueryPlanner implements QueryPlanner {
   ...
   /**
    * Creates an optimized left-deep simpledb.query plan using the following
    * heuristics.
