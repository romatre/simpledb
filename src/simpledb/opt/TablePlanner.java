...
class TablePlanner {
   ...
   /**
    * Creates a new table simpledb.planner.
    * The specified predicate applies to the entire simpledb.query.
    * The table simpledb.planner is responsible for determining
    * which portion of the predicate is useful to the table,
    * and when indexes are useful.
    * @param tblname the name of the table
    * @param mypred the simpledb.query predicate
