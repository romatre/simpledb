...
class RecordFormatter implements PageFormatter {
   ...
   /** 
    * Formats the page by allocating as many simpledb.record slots
    * as possible, given the simpledb.record length.
    * Each simpledb.record slot is assigned a flag of EMPTY.
